          ...
          <TabsList className="grid grid-cols-3 w-full mb-6 bg-blue-50 dark:bg-gray-900 p-1.5 rounded-lg border border-blue-100 dark:border-gray-700">
            ...
            >
              <div className="flex items-center">
                ...
                <span>All <span className="ml-1 font-medium bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded-full text-xs">
                  {criteria.length}
                </span></span>
              </div>
            </TabsTrigger>
            ...
            >
              <div className="flex items-center">
                ...
                <span>Passed <span className="ml-1 font-medium bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 px-1.5 py-0.5 rounded-full text-xs">
            ...
            >
              <div className="flex items-center">
                ...
                <span>Failed <span className="ml-1 font-medium bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200 px-1.5 py-0.5 rounded-full text-xs">
            ...
            >
              <div className="flex items-center">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span className="font-medium bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-200 px-1.5 py-0.5 rounded-full text-xs">
            ...
            >
              <div className="flex items-center">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span className="font-medium bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-200 px-1.5 py-0.5 rounded-full text-xs">
            ...
            >
              <div className="flex items-center">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span className="font-medium bg-teal-100 dark:bg-teal-900/30 text-teal-800 dark:text-teal-200 px-1.5 py-0.5 rounded-full text-xs">
            ...
            >
              <div className="flex items-center">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span className="font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 px-1.5 py-0.5 rounded-full text-xs">
