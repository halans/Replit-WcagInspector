    ...
    <div className="container mx-auto p-4 max-w-4xl">
      ...
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <p>
            Our tool is hosted on Replit and may use other third-party services for hosting and analytics. These services have their own privacy policies that govern how they use your information.
          </p>
